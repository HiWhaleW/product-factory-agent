        ...
        *,
        ...
        with self.session_factory.begin() as session:
            ...
            mvp_pack = ContextPack(
                ...
                agent_id="reviewer",
                task=(
                    "独立验收销售复盘 Agent MVP：复核 Runtime/API/PostgreSQL/Web 纵向闭环、"
