        ...
        waiting = _require(
            client.post(
                ...
                json={
                    ...
                    "user_input": (
                        "Research query: official sales conversation intelligence call recording "
                        "transcript coaching action items CRM Gong Clari report\n"
                        "调研 10–50 人 B2B 销售团队的销售复盘需求，重点验证会议转录、"
                        "可追溯结论、行动项和 CRM 安全边界；优先官方、原始报告和"
                        "一手来源。Evidence Index 逐条包含原始 EvidenceRef、标题、URL、"
                        "发布方/日期、支持的精确结论、段落/章节或可用的时间戳定位"
                        "与局限。MRD 中的市场事实和需求推导就近引用原始 "
                        "EvidenceRef。严格区分已验证事实、假设和待访谈项；不得把"
                        "搜索摘要写成全文证据，不得自动外发、修改 CRM、部署、"
                        "代替销售主管决策或推进项目状态。对 Reviewer 第一轮"
                        "反馈做明确修订：只把直接支持销售对话转录、复盘、辅导、"
                        "行动项或 CRM 可追溯性的来源标为直接证据；其他来源必须"
